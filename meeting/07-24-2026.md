...
- The first contractor to respond wins 70–80% of jobs
...
III) Cadence and Deliverables
- Scheduled to interview the customer on Thursday 8-9PM(CDT)

- Weekly check-in: Wednesdays, 9PM CDT - knowledge sharing/progress checkup ( This week will be Hieu's CockroachDB )

- FInal product deliverable - video demo covering :
+ Inpiration
+ What it does
+ How we built it
+ Architecture
+ Challenges we faced
+ What we learned
+ BUilt with (tools list)
+ Try it out/test API ( live,testable version )
( more researched needed to be done on Tri's side )
